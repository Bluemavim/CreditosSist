...
public class CancelacionManager {
     ...
     * @return
     */
    public List<Cancelacion> buscarCancelacion() {
     ...
     * @return
     */
    public List<Cancelacion> buscarCancelacion(int cancelacionId) {
        ...
        // si pasamos
        // como nombre: "' or '1'='1"
        Query query = session.createNativeQuery("SELECT * FROM cliente where nombre = '" + cancelacionId + "'", Cancelacion.class);

        List<Cancelacion> cancelacion = query.getResultList();
